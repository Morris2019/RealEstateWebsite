        ...
        <div class="container-scroller">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                    <a class="sidebar-brand brand-logo" href="index.html"><img src="{{asset('assets/logo.jpg')}}" alt="logo" /></a>
                    <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="{{asset('assets/logo.jpg')}}" alt="logo" /></a>
                </div>
                <ul class="nav">
